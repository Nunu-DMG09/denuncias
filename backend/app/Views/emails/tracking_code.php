                ...
                <table width="600" cellpadding="0" cellspacing="0" role="presentation" style="background:#ffffff;border-radius:8px;overflow:hidden;">
                    ...
                    <tr>
                        <td style="padding:28px 32px;color:#344054;">
                            <h2 style="margin:0 0 8px;font-size:20px;">Su denuncia fue registrada</h2>
                            <p style="margin:0 0 16px;color:#556074;">Gracias por enviar su denuncia. A continuación encontrará su código de seguimiento — guárdelo para consultar el estado.</p>
                            ...
                            <p style="margin:16px 0 0;color:#6b7280;font-size:14px;">
                                Si tiene problemas para acceder con el botón, use este código en la página de seguimiento o copie el enlace:
                            </p>
                            <p style="word-break:break-all;font-size:13px;color:#0b6db3;margin:8px 0 0;"><?= !empty($trackingUrl) ? esc($trackingUrl) : '' ?></p>
