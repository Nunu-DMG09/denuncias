							...
							<div className="col-span-1">
								...
								<div className="bg-white rounded-lg shadow-sm p-4 border-l-4 border-amber-400">
									...
									<button
										...
										className="w-full cursor-pointer disabled:bg-gray-400 disabled:cursor-not-allowed flex items-center justify-center px-4 py-2 bg-amber-500 text-white rounded-md shadow hover:bg-amber-600 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 transition-all duration-300 ease-in-out"
									>
										{isDownloading ? (
											<Loader isBtn={true} />
										) : (
