		...
		<div className="fixed inset-0 backdrop-blur-sm backdrop-saturate-100 bg-[#3a46500d] flex justify-center items-center z-50 animate__animated animate__fadeIn">
			<div className="bg-white p-8 rounded-lg w-96 shadow-xl animate__animated animate__zoomIn animate__faster">
				...
				<div className="flex justify-evenly items-center">
					<button
						className="bg-(--primary-color) text-white p-5 rounded-sm hover:bg-(--secondary-color) hover:scale-110 transition-all duration-300 ease-in-out"
						onClick={onCancel}
					>
						Cancelar
					</button>
					<button
						className="bg-transparent border-3 border-red-400 text-red-400 p-4 rounded-sm hover:bg-red-400 hover:text-white transition-all duration-300 ease-in-out"
