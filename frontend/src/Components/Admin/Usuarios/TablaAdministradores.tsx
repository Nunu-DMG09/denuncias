                ...
                <table className="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                        {administradores.map((admin: Administrador) => (
                            <tr key={admin.dni_admin} className="hover:bg-gray-50">
                                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{admin.dni_admin}</td>
                                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{admin.nombres}</td>
                ...
                <div className="fixed inset-0 backdrop-blur-[2px] bg-slate-400/20 flex items-center justify-center z-50">
                    <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4 shadow-xl">
                        ...
                        <p className="text-gray-600 text-center mb-6">
                            ...
                            <span className="font-semibold">{adminToDelete?.nombres}</span>?
                            <br />
